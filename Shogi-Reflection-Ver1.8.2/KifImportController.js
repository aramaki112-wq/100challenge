...
export class KifImportController {
  ...
  constructor({ importService, formMapper, pastedTextAdapter = null } = {}) {
    ...
    this.pastedTextAdapter = pastedTextAdapter;
  }
  ...
  async selectText({ text, sourceFileName = "clipboard-paste.kifu" } = {}) {
    assertMethod(this.pastedTextAdapter, "toFile", "pastedTextAdapter");
    const file = this.pastedTextAdapter.toFile({ text, sourceFileName });
