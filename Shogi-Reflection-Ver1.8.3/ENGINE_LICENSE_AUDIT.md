...
| generated pthread Worker | actual filename determined after build | Emscripten output | generated provenance | same post-build audit rule | conditional | generated | NOT PRESENT CURRENTLY | notice/source association required | legal separation from app is NOT assumed | CONDITIONAL | Worker boundary does not settle GPL characterization |
