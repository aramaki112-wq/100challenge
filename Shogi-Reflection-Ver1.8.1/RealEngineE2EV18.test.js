...
test("ReflectionLocal fallback E2E / short KIF", async () => {
...
test("ReflectionLocal fallback E2E / normal KIF", async () => {
...
test("ReflectionLocal fallback E2E / long KIF uses smartphone safety cap", async () => {
