...
def run() -> int:
    ...
    with sync_playwright() as p:
        ...
        checks.check("Ver1.4.1 title", "Ver.1.4.1" in page.title(), page.title())
        ...
        # Register KIF -> Step2 and save game only. Use opening header for Ver.1.4.1 summary verification.
    ...
    result_lines = [
        "Shogi Reflection Ver.1.4.1 Browser Verification",
        "==============================================",
