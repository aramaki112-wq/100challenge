...
def run() -> int:
    ...
    with sync_playwright() as p:
        ...
        checks.check("Application title", page.title() == "将棋振り返りアプリ Ver.1.3.2｜Replay UX・スマートフォン操作改善", page.title())
        ...
        checks.check("Cancel clears pasted text", page.locator("#kif-paste-text").input_value() == "")
    ...
    report = [
        "Shogi Reflection Ver.1.3.2 Browser Verification",
        "Date: 2026-08-08",
        "",
        "Execution method:",
        ...
        "- Ver.1.3.2 Page scrollY stability, 300-move Replay, Move List internal scroll and 390px touch target",
        "",
    ]
    report.extend(
